...
const ProductsSection = ({ onAddToCart }: ProductsSectionProps) => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      image: eggs30White,
      description:
        "Volume perfeito para quem precisa de praticidade todos os dias.",
    },
    {
      id: 4,
  ...
  return (
    <section id="produtos" className="py-16 bg-background bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-[#ee7923] text-3xl md:text-4xl font-bold  mb-4 uppercase">
            Nossos Produtos
          </h2>
          <p className="text-[#faaf40]  text-lg text-muted-foreground max-w-2xl mx-auto">
            Mais frescor, mais sabor, mais nutrição. Nossos ovos chegam direto
            da granja para garantir o melhor para você e sua família. Escolha a
            quantidade ideal para suas receitas.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {products.map((product) => (
            <Card
              key={product.id}
              className="product-card bg-card border-border"
            >
              ...
              <CardFooter className="p-6 pt-0">
                <Button
                  ...
                  className="w-full bg-primary hover:bg-primary-glow text-primary-foreground bg-[#ee7923] hover:bg-[#faaf40] text-white uppercase"
                >
