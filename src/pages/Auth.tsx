        ...
        const checkAdminRole = async () => {
          ...
          if (isAdmin) {
            ...
            if (!addressData) {
              ...
              toast({
                title: "Login realizado!",
                description: "Por favor, complete seu cadastro com endereço de entrega.",
              });
                ...
                <form onSubmit={handleUpdatePassword} className="space-y-4">
                  ...
                  <div>
                    ...
                    {errors.confirmNewPassword && (
                      <p className="text-sm text-destructive mt-1">{errors.confirmNewPassword}</p>
                    )}
                  </div>
                  ...
                  <form onSubmit={handleSignUp} className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Select value={signUpData.neighborhood} onValueChange={(value) => handleSignUpChange("neighborhood", value)}>
                          <SelectTrigger>
